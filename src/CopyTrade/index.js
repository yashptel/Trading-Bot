...
const CopyTrade = () => {
  ...
  const [positionSizeMaster, setPositionSizeMaster] = useState(0);
  const [entryPriceMaster, setEntryPriceMaster] = useState(0);
  ...
  useEffect(() => {
    const multiplier =
      Math.abs(Number(takeProfit) - Number(entryPriceMaster)) /
        ...
        <div className="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
          <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
            ...
            <form className="space-y-4 md:space-y-6" action="#">
              ...
              <div className="px-2 py-4 border border-gray-300 rounded-lg space-y-3 md:space-y-5">
                <div>
                  <label
                    htmlFor="entryPriceMaster"
                    className="block mb-2 text-sm font-medium text-gray-900 dark:text-white"
                  >
                  ...
                  <input
                    type="tel"
                    name="entryPriceMaster"
                    id="entryPriceMaster"
                    className="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                    required=""
                    value={entryPriceMaster}
                    onChange={(e) =>
                      handleInputChangeOnlyNumbers(e, setEntryPriceMaster)
                    }
                  ></input>
                </div>
                ...
                <div>
                  <label
                    htmlFor="positionSizeMaster"
                    className="block mb-2 text-sm font-medium text-gray-900 dark:text-white"
                  >
                    Master's Position Size
                  </label>
                  <input
                    type="tel"
                    name="positionSizeMaster"
                    id="positionSizeMaster"
                    className="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                    value={positionSizeMaster}
                    prefix="$"
                    onChange={(e) =>
                      handleInputChangeOnlyNumbers(e, setPositionSizeMaster)
                    }
                  ></input>

                  <div className="mt-1.5">
                    {_.map([3000, 4000, 5000, 6000, 7000], (val) => {
